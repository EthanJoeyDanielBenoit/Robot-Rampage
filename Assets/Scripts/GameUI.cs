...
public class GameUI : MonoBehaviour
{
    ...
    {
        waveClearedText.GetComponent<Text>().enabled = true;
    ...
    IEnumerator hideWaveClearBonus()
    {
        ...
        waveClearedText.GetComponent<Text>().enabled = false;
    }
    ...
    public void ShowNewWave()
    {
        ...
        nextWaveText.GetComponent<Text>().enabled = true;
    }

    IEnumerator hideNewWaveText()
    {
        yield return new WaitForSeconds(4);
        nextWaveText.GetComponent<Text>().enabled = false;
    }
